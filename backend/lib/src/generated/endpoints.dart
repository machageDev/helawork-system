        ...
        'assignTask': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['task'] as _i6.TaskEndpoint).assignTask(
            session,
            params['taskId'],
            params['workerId'],
          ),
        ...
        'updateTaskStatus': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['task'] as _i6.TaskEndpoint).updateTaskStatus(
            session,
            params['taskId'],
            params['status'],
          ),
        ...
        'getTasksForEmployer': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['task'] as _i6.TaskEndpoint).getTasksForEmployer(
            session,
            params['employerId'],
          ),
        ),
        'getTasksForWorker': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['task'] as _i6.TaskEndpoint).getTasksForWorker(
            session,
            params['workerId'],
          ),
        ),
        ...
        'startLog': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['timeLog'] as _i7.TimeLogEndpoint).startLog(
            session,
            params['workerId'],
            params['taskId'],
          ),
        ...
        'stopLog': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['timeLog'] as _i7.TimeLogEndpoint).stopLog(
            session,
            params['logId'],
          ),
        ),
